...
const auditLogSchema = new mongoose.Schema({
  ...
  eventName: {
    ...
    enum: [
      ...
      'PAYMENT.DISPUTE_EVIDENCE_SUBMITTED',
      'PAYMENT.PROVIDER_STATE_CHANGED',
      ...
      'INVENTORY.LOCATION_UPDATED',
      'INVENTORY.POSITION_CONTROLS_UPDATED',
      ...
      'COMMERCE.CONFIG.DRAFT_CREATED',
      'COMMERCE.CONFIG.DRAFT_UPDATED',
      'COMMERCE.CONFIG.VALIDATED',
      'COMMERCE.CONFIG.SCHEDULED',
      'COMMERCE.CONFIG.ACTIVATED',
      'COMMERCE.CONFIG.SUPERSEDED',
      'COMMERCE.CONFIG.RETIRED',
      'COMMERCE.CONFIG.REVOKED',
      'COMMERCE.CONFIG.PREVIEWED',
      'EXCEPTION.CREATED',
      'EXCEPTION.ACKNOWLEDGED',
      'EXCEPTION.ASSIGNED',
      'EXCEPTION.ESCALATED',
      'EXCEPTION.RETRY_TRIGGERED',
      'EXCEPTION.RESOLVED',
      'EXCEPTION.DISMISSED',
      'DOCUMENT.ISSUED',
      'DOCUMENT.VOIDED',
